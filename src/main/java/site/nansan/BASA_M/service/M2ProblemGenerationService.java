...
public class M2ProblemGenerationService {
    ...
    /** 받아올림 없는 두자리 + 한자리 */
    public CalculationResponse generateM2_1Problem() {
    ...
    /** 받아내림 없는 두자리 - 한자리 */
    public CalculationResponse generateM2_2Problem() {
        int operand1 = RandomUtil.generateRandomNDigitInt(2);
        while(operand1 % 10 == 0) {
            operand1 = RandomUtil.generateRandomNDigitInt(2);
    ...
    /** 받아올림 없는 두자리 + 두자리 */
    public CalculationResponse generateM2_3Problem() {
    ...
    /** 받아내림 없는 두자리 - 두자리 */
    public CalculationResponse generateM2_4Problem() {
