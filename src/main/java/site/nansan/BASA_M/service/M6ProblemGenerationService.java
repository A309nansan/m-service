...
public class M6ProblemGenerationService {
    /** 세자리 * 한자리 */
    public GeneratedProblemResponse generateM6_1Problem() {
    ...
    /** 두자리 * 두자리 */
    public GeneratedProblemResponse generateM6_2Problem() {
    ...
    public GeneratedProblemResponse generateM6_3Problem() {
    ...
    /** 나머지가 있는 두자리수 / 한자리수 */
    public GeneratedProblemResponse generateM6_4Problem() {
        int dividend = RandomUtil.generateRandomIntBetween(10,99);
        int divisor = RandomUtil.generateRandomIntBetween(1,9);
        while(dividend % divisor == 0){
            dividend = RandomUtil.generateRandomIntBetween(10,99);
    ...
    /** 나머지가 없는 세자리수 / 한자리수*/
    public GeneratedProblemResponse generateM6_5Problem() {
        int dividend = RandomUtil.generateRandomIntBetween(10,99);
        int divisor = RandomUtil.generateRandomIntBetween(1,9);
        if(divisor==1)
            divisor = RandomUtil.generateRandomIntBetween(1,9);
    ...
    /** 나머지가 있는 세 자리수 / 한 자리수 */
    public GeneratedProblemResponse generateM6_6Problem() {
        int dividend = RandomUtil.generateRandomIntBetween(10,99);
